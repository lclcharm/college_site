    ...
    <div class="sign-up-container">
      ...
      <div class="more-sign">
        ...
        <ul>
          ...
          <!-- <li><a id="phone" class="phone" target="_blank" href="#"><i class="iconfont icon-phone" /></a></li> -->
        </ul>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    submitLogin() {
      ...
      loginApi.submitLogin(this.user).then(response => {
        ...
        // this.$message.success('進來了' + response.data.token)
        cookie.set('jwt_token', response.data.token)
        // this.$message.success('進來' + cookie.get('jwt_token'))
        // 跳转到首页
